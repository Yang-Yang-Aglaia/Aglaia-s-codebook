function [raw_chosetwo,raw_chose12,raw_chose22,raw_chose32,raw_chose42]=FeedbackTwoDC(w1,u1,u2,u3,u4,xCenter,yCenter,font_size,black,red,raw_choseone)
%初始化
raw_chose12 = 0;
raw_chose22 = 0;
raw_chose32 = 0;
...
fwrite(u1,[raw_chosetwo]);
fwrite(u2,[raw_chosetwo]);
fwrite(u3,[raw_chosetwo]);
fwrite(u4,[raw_chosetwo]);

[colori] = Comp12(raw_choseone,raw_chosetwo);
