...
function [subID,subNo,gender,name,version,Gender,hand,age,IP2,IP3,IP4,IP5,fp] = ParticipantInformation()
subID = '0';
Gender = '1';
Name = '';
Version = '2';  %为什么变成4
Hand = '1';
Age = '';
promptParameters = {'Subject ID' 'Gender' 'Name' 'Version' 'Hand' 'Age'};
defaultParameters = {subID,Gender,Name,Version,Hand,Age};
...
hand = str2double(Settings{5});
age = str2double(Settings{6});
