                ...
                while Inicheck == 0
                    ...
                    for ii = 1:trial_rep
                        for checki = 1:5
                            ...
                            [chose_RT,position_chose,confidence_rating,confidence_rating_RT,raw_choseone,raw_chose11,raw_chose21,raw_chose31,raw_chose41] = KeyBoard1(w1,more,rateless,ratemore,stop_rating,escape_action,less,xCenter,...
...
%                     end
    ...
    yCenter,move_left,move_right,chose_onset,red,frame_left_left,GetSecs,triangle,SCALE_GL,u1,u2,u3,u4,font_size,black);  %判断按键(第一次判断)
                ...
                % 等待第二次反应
                [raw_chosetwo,raw_chose12,raw_chose22,raw_chose32,raw_chose42]=FeedbackTwo(w1,u1,u2,u3,u4,xCenter,yCenter,font_size,black); %等待他人更改后（第二次选择）反馈
                ...
                while decision_check==1
                    ...
                    %按键
                    [decision_RT,decision_check,group_decision,decision_confidence_rating,decision_confidence_rating_RT] = KeyBoard2(w1,more,rateless,ratemore,stop_rating,escape_action,less,xCenter,...
    ...
    columheader ={'SubNo','Group','Version','Gender','Age','Handedness','ACC','PositionChose','ConfRate',...
        'RToConfRate','RawChoseOne','DecisionRT','GroupDecision','GroupDecisionRate','RToGroupDecisionRate'};
