function [chose_RT,position_chose,confidence_rating,confidence_rating_RT,raw_chosesum] = KeyBoard1DC(w1,more,rateless,ratemore,stop_rating,escape_action,less,xCenter,...
...
%         CheckConnection411 = CheckConnection41;
        ...
        [raw_chosesum] = feedback1DC(w1,u1,xCenter,yCenter,font_size,black);  %第一次读取leader选择（反馈）
