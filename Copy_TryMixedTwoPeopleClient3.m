...
%                     end
                ...
                [chose_RT,position_chose,confidence_rating,confidence_rating_RT,raw_chose1] = KeyBoard1(w1,more,rateless,ratemore,stop_rating,escape_action,...
                    less,xCenter,yCenter,move_left,move_right,chose_onset,red,frame_left_left,GetSecs,triangle,SCALE_GL,u1,font_size,black);
...
%                 feedback1(w1,u1,xCenter,yCenter,font_size,black);  %第一次读取leader选择（反馈）
                ...
                result(trials,1).RawChoseOne = raw_chose1;
                ...
                while decision_check==1
                    ...
                    %群体最终选择
                    [raw_chose_leader]=FinaFeed(w1,u1,xCenter,yCenter,font_size,black);
    ...
    columheader ={'SubNo','Group','Version','Gender','Age','Handedness','ACC','PositionChose','ConfRate',...
        'RToConfRate','RawChoseOne','DecisionRT','Position_chose2','SecDecisionRate','RToGroupDecisionRate2'};
