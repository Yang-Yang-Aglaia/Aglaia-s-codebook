function [decision_RT,decision_check,group_decision,decision_confidence_rating,decision_confidence_rating_RT] = KeyBoard2DC(w1,more,rateless,ratemore,stop_rating,escape_action,less,xCenter,...
